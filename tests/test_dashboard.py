...
class DashboardTests(unittest.TestCase):
    ...
    def test_render_dashboard_html_includes_sections_and_escapes_content(self) -> None:
        ...
        self.assertIn('id="readiness-panel"', html)
        self.assertIn('id="flow-panel"', html)
        self.assertIn('id="metrics-panel"', html)
        self.assertIn('id="metrics-status"', html)
        self.assertIn('id="metrics-version"', html)
        self.assertIn('id="liquidity-grid"', html)
        self.assertIn('id="history-diagnostics"', html)
        self.assertIn('id="versions"', html)
        self.assertIn('id="session-id"', html)
        self.assertIn('id="active-levels"', html)
        self.assertIn('id="broken-levels"', html)
        ...
        self.assertIn("renderReadinessPanel", html)
        self.assertIn("renderOrderflowPanel", html)
        self.assertIn("renderMetricsPanel", html)
        self.assertIn("renderLevelMeta", html)
        self.assertIn("levelIsActive", html)
        self.assertIn("coverage", html)
        self.assertIn("invalidation_reason", html)
        self.assertIn("market?.readiness", html)
        ...
        self.assertIn("event.button!==0", html)
        self.assertIn("{mode:'pan-xy'", html)
        self.assertNotIn("event.button===2", html)
        self.assertIn("Drag: move X/Y", html)
        self.assertIn("function clampYOffset()", html)
        self.assertIn("clampYOffset();const baseSpan", html)
        self.assertIn(".chart-panel{min-width:0;overflow:hidden}", html)
