...
class DashboardTests(unittest.TestCase):
    ...
    def test_render_dashboard_html_includes_sections_and_escapes_content(self) -> None:
        ...
        self.assertNotIn('id="readiness-panel"', html)
        self.assertNotIn('id="flow-panel"', html)
        self.assertNotIn('id="metrics-panel"', html)
        self.assertNotIn('id="metrics-chip"', html)
        self.assertNotIn('id="active-levels"', html)
        self.assertNotIn('id="broken-levels"', html)
        self.assertIn('id="paths-count"', html)
        self.assertIn('id="pane-paths"', html)
        self.assertIn("market?.signal_paths", html)
        self.assertIn('.symbol-reason,.tab[data-tab="paths"]', html)
        self.assertIn("grid-template-rows:minmax(0,1fr) clamp(210px,26vh,280px) auto", html)
        ...
        self.assertNotIn("renderReadinessPanel", html)
        self.assertNotIn("renderOrderflowPanel", html)
        self.assertNotIn("renderMetricsPanel", html)
        self.assertNotIn("renderLevelMeta", html)
